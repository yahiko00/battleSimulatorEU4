...
var Army = (function () {
    ...
    Army.prototype.getMoral = function (type) {
        var moral = 0.0;
    ...
    Army.prototype.getMenDayLoss = function (type) {
        var result = 0;
    ...
    Army.prototype.getMoralDayLoss = function (type) {
        var sum = 0;
    ...
    Army.prototype.getMenCumLoss = function (type) {
        var sum = 0;
    ...
    Army.prototype.getMoralCumLoss = function (type) {
    ...
    Army.prototype.applyDamage = function () {
        for (var i = 0; i < this.units.length; i++) {
            var unit = this.units[i];
...
var Battle = (function () {
    ...
    Battle.prototype.baseMoralDamage = function (dieResult) {
        if (dieResult <= -2) {
            return 1;
        } else if (dieResult == -1) {
            return 2;
    ...
    Battle.prototype.moralDamage = function (baseMoralDamage, men, moralMax, combatAbility, discipline, tactics) {
    ...
    Battle.prototype.computeDamage = function (unit, die, leadAttSkill, leadDefSkill, attMoralMax, terMod) {
